...
const Navbar = () => {
    ...
    return (
        <nav className={'bg-black h-[4rem] w-full sticky top-0'}>
            <div className={'h-full w-full flex flex-row items-center justify-between'}>
                <div className={'h-full w-1/2 flex flex-row items-center ml-10'}>
                    <a href="/">
                        <img className={'h-[32px] w-[92px] object-scale-down'}
                ...
                <div className={'h-full w-1/3 flex flex-row justify-end mr-10 items-center gap-6'}>
                    <svg version="1.1"
                         fill={'#fff'}
                         width={'24px'}
                         height={'24px'}
                    ...
                    <a className={'text-white text-[.7rem]'}
                       href="/">Kids</a>
                    <svg version="1.1"
                         width={'24px'}
                         height={'24px'}
